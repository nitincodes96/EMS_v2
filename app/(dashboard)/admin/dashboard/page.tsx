...
const SYSTEM_LOGS: {
    ...
    time: string;
        ...
        { id: "2", type: "user", message: "New department onboarded", meta: "Vertex Labs", time: "18m ago" },
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                        Overview across all departments on the organization.
                    </p>
                </div>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-slate-500">
                                    On time vs. late vs. absent, across all departments.
                                </p>
                            </div>
                        </div>
